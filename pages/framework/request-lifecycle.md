...
description: 'Жизненный цикл запроса. Документация по Bitrix Framework: принципы работы, архитектура и примеры использования.'
---
...
Подробную информацию читайте в статье [Роутинг](./routing).
...
О жизненном цикле контроллера читайте в статье [Контроллеры](./controllers#жизненный-цикл-контроллера).
